package PsychologicalMod.character;
...
import static PsychologicalMod.PsychologicalMod.characterPath;
import static PsychologicalMod.PsychologicalMod.makeID;

public class PsychologicalCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Psychological"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass PSYCHOLOGICAL_CHARACTER;
        @SpireEnum(name = "PSYCHOLOGICAL_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "PSYCHOLOGICAL_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public PsychologicalCharacter() {
        super(NAMES[0], Enums.PSYCHOLOGICAL_CHARACTER,
    ...
    public AbstractPlayer newInstance() {
        ...
        return new PsychologicalCharacter();
    }
}
